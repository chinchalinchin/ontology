#### Refactor: Phase 03.03 - Motion Modules

In the recent refactors, velocity-based motion and momentum transfer collisions were implemented for Players and Sprites alike. After experimenting with the setup, it is decided the momentum-based controls (i.e. conservation of momentum making it hard to come to a complete without zeroing out) need adjusted. Momentum-based motion will be a great addition for Sprites and Objects, but cannot stay for Players.
