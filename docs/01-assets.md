...
First, Assets are divided into *mutable* and *immutable* categories. *Immutable* Assets never have their state altered by the game loop. *Mutable* objects change their state based on Intent generated by the game loop.
