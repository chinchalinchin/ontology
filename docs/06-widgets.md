...
The types of Events are further enumerated below,

- MenuEvent: Event generated to trigger Menu instantiation
- SelectionEvent: Event generated by Widgets during the course of the MenuEvent, to be handled by the [Menu Controller](#controllers).
- StateEvent: Event generated to signal the [Engine](./00-overview.md#engine) to load the game state and migrate it onto the [Board](./00-overview.md#board).
- UpdateEvent: Event generated 
