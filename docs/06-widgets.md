...
- UpdateEvent: Event generated by Widgets to signal the Menu should re-render its state, e.g. redraw Meters or scroll text in a Page.
...
* The Engine loops over menu.widgets.values() and pushes primitive tuples across the Cython boundary.
